...
export const EDDYSTONE_EID: string   = 's:0-1=feaa,m:2-2=30,p:3-3:-41,i:4-11';
...
export type BeaconManagerIOS = {
  ...
  // eddystone
  setupEddystoneEIDLayout: () => void,
  setupEddystoneUIDLayout: () => void,
  setupEddystoneURLLayout: () => void,
  startScanningEddytone: () => void,
  stopScanningEddystone: () => void
};
