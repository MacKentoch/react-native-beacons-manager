...
function removeAltBeaconsDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(ALTBEACON, resolve);
  });
}
// #endregion
...
function detectEstimotes(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_ESTIMOTE, resolve);
  });
}
...
function removeEstimotesDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_ESTIMOTE, resolve);
  });
}
// #endregion
...
function detectEddystoneUID(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(EDDYSTONE_UID, resolve);
  });
}
...
function removeEddystoneUIDDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(EDDYSTONE_UID, resolve);
  });
}
// #endregion
...
function detectEddystoneURL(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(EDDYSTONE_URL, resolve);
  });
}
...
function removeEddystoneURLDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(EDDYSTONE_URL, resolve);
  });
}
// #endregion
...
function detectEddystoneTLM(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(EDDYSTONE_TLM, resolve);
  });
}
...
function removeEddystoneTLMDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(EDDYSTONE_TLM, resolve);
  });
}
// #endregion
...
function detectCustomBeaconLayout(
  ...
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(parser, resolve);
  });
}

function addCustomBeaconLayoutDetection(
  parser: number
): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(parser, resolve);
...
function removeCustomBeaconLayoutDetection(
  parser: number
): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(parser, resolve);
  });
}
// #endregion
