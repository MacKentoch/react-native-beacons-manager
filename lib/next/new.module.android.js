...
function detectAltBeacons(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(ALTBEACON, resolve, reject);
  });
}
...
function removeAltBeaconsDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(ALTBEACON, resolve, reject);
  });
}
// #endregion
...
function detectEddystoneUID(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(EDDYSTONE_UID, resolve, reject);
  });
}
...
function removeEddystoneUIDDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(EDDYSTONE_UID, resolve, reject);
  });
}
// #endregion
...
function detectEddystoneURL(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(EDDYSTONE_URL, resolve, reject);
  });
}
...
function removeEddystoneURLDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(EDDYSTONE_URL, resolve, reject);
  });
}
// #endregion
...
function detectEddystoneTLM(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(EDDYSTONE_TLM, resolve, reject);
  });
}
...
function removeEddystoneTLMDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(EDDYSTONE_TLM, resolve, reject);
  });
}
// #endregion
