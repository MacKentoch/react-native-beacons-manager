...
const BeaconsManager: iBeaconManagerIOS = RN.NativeModules.RNiBeacon;
const EddystoneManager: EddystoneIOS = RN.NativeModules.RNEddystone;
const EddystoneEventEmitter = new RN.NativeEventEmitter(RN.NativeModules.RNEddystone);

function detectEddystoneEID(): void {
  EddystoneManager.detectEddystoneEID();
}

function detectEddystoneUID(): void {
  EddystoneManager.detectEddystoneUID();
}

function detectEddystoneURL() : void {
  EddystoneManager.detectEddystoneURL();
}
